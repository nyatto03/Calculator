# da bat loi so am, co dieu kien so chu so toi da nhap vao, chua bat loi nhap sai ki tu.
.data 
  welc:         .asciiz "\n Xin chao!\n" 
...
.eqv IN_ADDRESS_HEXA_KEYBOARD   0xFFFF0012  # chua byte dieu khien dong cua ban phim /row
